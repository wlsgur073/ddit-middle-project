 ...
 */
	this.init_naver_id_login = function ()
	{
		...
		{
			naver_id_login_contents="<a href='"+naver_id_login_url+"' "+naver_id_popup_option+" id='naver_id_login_anchor'><img src='../images/naverLoginLarge.jpg' width='100%' style='border-radius: 5px;' border='0' title='네이버 아이디로 로그인'>";
		}
		else 
		{
