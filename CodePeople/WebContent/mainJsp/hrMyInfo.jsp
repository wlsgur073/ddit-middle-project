         ...
         %>
          ...
          %>     
                     ...
                     <div class="my-btn-box my-btn-box-cv">
                           <a href="/CodePeople/mainJsp/hrEduDelete.jsp?hrNo=<%=hrNo%>&eduNo=<%=edu.getEduNo()%>&eduCodeNo=<%=edu.getEduCodeNo()%>">
                  ...
                  <div class="card-body">
                    ...
                    <span class="board-detail-content">
                     ...
                     <div class="my-btn-box my-btn-box-cv">
                                ...
                                <a href="/CodePeople/mainJsp/hrCrrDelete.jsp?hrNo=<%=hrNo%>&crrNo=<%=crr.getCrrNo() %>">
                                <button type="button" class="btn btn-outline-primary">삭제</button></a>
                            </div>
              </div>				
			<%
		...
		<div class="board-card">
            <div class="board-detail">
              <a href="#" class="card-link"><span class="board-title company-name plCodeNm" ><%=pl.getPlCodeNm() %></span></a>&nbsp;&nbsp;
                 ...
                 <div class="my-btn-box my-btn-box-cv">                      
                                <a href="/CodePeople/mainJsp/PlDelete.jsp?hrNo=<%=hrNo%>&plCodeNo=<%=pl.getPlCodeNo() %>">
                                <button type="button" class="btn btn-outline-primary">삭제</button></a>
                            </div>
  		...
  		<div class="board-card">
            <div class="board-detail">
              <a href="#" class="card-link"><span class="board-title company-name certCodeNm" ><%=cert.getCertCodeNm() %></span></a>&nbsp;&nbsp;          
                 ...
                 <div class="my-btn-box my-btn-box-cv">
                                <a href="/CodePeople/mainJsp/hrCertDelete.jsp?hrNo=<%=hrNo%>&certCodeNo=<%=cert.getCertCodeNo() %>"><button type="button" class="btn btn-outline-primary">삭제</button></a>
