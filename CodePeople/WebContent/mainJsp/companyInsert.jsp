		...
		<form action="/action_page.php" id="comInsert">
			...
			<div class="dropdown mb-3">
				...
				<div id="search-item">
					...
					<input class="form-control"	id="jgCodeNo" type="hidden" name="jgCodeNo">
				</div>
				<button type="button" id="jobgroupbtn"
					class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown">직군
					선택</button>
				<ul class="dropdown-menu">
					<li><a class="dropdown-item" onclick="setValue(this)" idx="1">개발</a></li>
					<li><a class="dropdown-item" onclick="setValue(this)" idx="1">영업</a></li>
					<li><a class="dropdown-item" onclick="setValue(this)" idx="1">유지보수</a></li>
				</ul>
			</div>
			<br>
			...
			<div class="mb-3">
				<input type="hidden" class="form-control" id="cityCodeNo"
					name="cityCodeNo">
			</div>

			<div class="mb-3">
				<input type="hidden" class="form-control" id="provCodeNo"
					name="provCodeNo">
			</div>
